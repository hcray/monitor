...
import com.daoliuhe.monitor.utils.PubUtils;
import com.daoliuhe.monitor.utils.PublicUtil;
...
public class MailEntity implements Serializable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MailEntity.class);
    ...
    public static SimpleMailMessage createSimpleMailMessage(String subject, String text, Set<String> to) {
        logger.info("SimpleMailMessage subject={}, text={}, to={}", subject, text, to);
